...
const char *ssid = "vsvai";
const char *password = "lenovoturbo";
const char* device_token  = "e1bf65007141535e";
//************************************************************************
int timezone = 19800;   //Replace "x" your timezone.
int time_dst = 0;
String getData, Link;
String OldCardID = "";
unsigned long previousMillis1 = 0;
unsigned long previousMillis2 = 0;
String URL = "http://192.168.1.53/rfidattendance/getdata.php"; //computer IP or the server domain
//*************************Biometric Icons*********************************
